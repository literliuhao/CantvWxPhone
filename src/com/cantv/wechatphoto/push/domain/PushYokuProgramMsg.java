...
public class PushYokuProgramMsg implements IPushMessage {
	...
	private YokuVideo video;// 进播放器播放的单集影片

	@Override
	public PushYokuProgramMsg parse(JsonObject data)
		...
		try {
			...
			video = new Gson().fromJson(videoJs, YokuVideo.class);
		} catch (Exception e) {
			video = null;
		}
		return this;
	...
	public YokuVideo getVideo() {
		return video;
	}

	public void setVideo(YokuVideo video) {
		this.video = video;
	}

	@Override
	public String toString() {
		return "PushYokuProgramMsg [programId=" + programId + ", chargeType=" + chargeType + ", playIndex=" + playIndex
