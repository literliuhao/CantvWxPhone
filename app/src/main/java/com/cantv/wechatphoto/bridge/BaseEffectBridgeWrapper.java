package com.cantv.wechatphoto.bridge;
...
public class BaseEffectBridgeWrapper extends BaseEffectBridge {
	...
	/**
	 * 继承这个类重写的话.<br>
	 * 记得 super.onInitBridge(view);
	 */
	@Override
	public void onInitBridge(PopView view) {
	 ...
	 */
	@Override
	public void setMainUpView(PopView view) {
