...
public class PushSohuProgramMsg implements IPushMessage {
	...
	private SohuVideo video;// 进播放器播放的单集影片

	@Override
	public PushSohuProgramMsg parse(JsonObject data)
		...
		try {
			...
			video = new Gson().fromJson(videoJs, SohuVideo.class);
		} catch (Exception e) {
			video = null;
		}
		return this;
	...
	public SohuVideo getVideo() {
		return video;
	}

	public void setVideo(SohuVideo video) {
		this.video = video;
	}

	@Override
	public String toString() {
		return "PushSohuProgramMsg [programId=" + programId + ", chargeType=" + chargeType + ", playIndex=" + playIndex
